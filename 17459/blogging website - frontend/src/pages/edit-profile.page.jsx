...
const uploadImageToServer = async (imageFile, token) => {
    const formData = new FormData();
    formData.append("banner", imageFile); // Your backend expects the "banner" field
...
const EditProfile = () => {
    ...
    const handleImageUpload = (e) => {
        ...
        if (updatedProfileImg) {
            ...
            uploadImageToServer(updatedProfileImg, access_token)
                .then((url) => {
