      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Quick Options
            _profileOption(icon: Icons.edit, label: "Edit Profile", onTap: () {Navigator.push(
              context,
            ...
            _profileOption(icon: Icons.history, label: "Order History", onTap: () {Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const OrderHistoryScreen()),
            );}),
            // _profileOption(icon: Icons.settings, label: "Settings", onTap: () {}),
            _profileOption(icon: Icons.description, label: "Terms & Conditions", onTap: () {Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const TermsAndConditionsScreen()),
            );}),
            _profileOption(icon: Icons.support_agent, label: "Customer Support", onTap: () {Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const ContactSupportScreen()),
            );}),
            _profileOption(icon: Icons.privacy_tip_outlined, label: "Privacy Policy", onTap: () {Navigator.push(
              context,
            ...
            Center(
              child: Column(
                children: [
                  ...
                  Text("Developed by Richa Kumari", style: TextStyle(color: Colors.grey[600], fontSize: width * 0.03)),
                ],
              ),
            ),
