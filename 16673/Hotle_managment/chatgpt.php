...
<head>
    ...
    <style>
    /* Custom CSS for fixed widths */
    #dashboard-menu {
        width: 250px;
        /* Fixed width for the admin panel */
    }

    #main-content {
        margin-left: 250px;
        /* Adjust margin to match the width of the admin panel */
    ...
    .col-lg-10 {
        width: 100%;
        /* Ensure the settings section takes up the remaining space */
    }
    </style>
</head>
