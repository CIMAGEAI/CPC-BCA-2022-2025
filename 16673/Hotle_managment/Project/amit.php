 ...
 <style>
     ...
     .swiper-container {
      width: 100%;
      height: 500px; /* Set the desired height of the Swiper container */
    }
...
<div class="modal fade" id="ResisterModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h5 class="modal-title d-flex align-items-center " >
        <i class="bi bi-person-dash-fill fs-3 me-2"></i>User Registration</h5>
            <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">Note: Your detail must match with your Id (Aadhaar card,password, driving license, etc.)
      ...
      <form>
        <div class="row align-items-end">
          ...
          <div class="col-lg-1 mt-2 mb-lg-3">
            <button type="submit" class="btn custom-bg text-white shadow-none custom-bg">Submit</button>
          </div>
        </div>
      </form>
    </div>
