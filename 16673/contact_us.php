...
<body>
    ...
    <div class="my-5 px-4">
        ...
        <p class="text-center mt-3">Some systems also provide a contact form where users can submit inquiries or
            feedback directly.
            This feature helps improve communication,<br> resolve issues quickly, and enhance customer satisfaction.
            It may also include links to social media or support chat for more immediate assistance.</p>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4 rounded shadow">
                ...
                <h5>Address</h5>
                <a href="https://maps.app.goo.gl/3oAFbJh8SkGGZBAD8" target="_blank"
                    class="d-inline-block text-decoration-none text-dark mb-2"><i class="bi bi-geo-alt"></i>Tj,Hotel,
                    patliputra Patna , Bihar</a>
                <h5 class="mt-2">Call us</h5>
                <a href="tel: +91 9060735605" class="d-inline-block text-decoration-none text-dark">
                    <i class="bi bi-telephone"></i>+91 9142609665
                </a>
                <br>
                <a href="tel: +91 9060735605" class="d-inline-block text-decoration-none text-dark">
                    <i class="bi bi-telephone"></i>+91 9142609665
                ...
                <a href="mailto:suryant5605@gmail.com" class="d-inline-block text-decoration-none text-dark">
                    <i class="bi bi-envelope p-2"></i>kumararyan19242@gmail.com</a>
                ...
                <div class="bg-white rounded shadow p-4 ">
                    <form method="POST" action="submit_comment.php">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="message" class="form-control shadow-none" rows="3" required></textarea>
                        </div>
