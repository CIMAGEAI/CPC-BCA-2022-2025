    ...
    SignupOne(){
        ...
        t1.setFont(new Font("Raleway", Font.BOLD, 14));
           t1.addKeyListener(new KeyAdapter (){
            public void keyTyped(KeyEvent e){
                    ...
                    if (!Character.isLetter(ch) && ch != ' ' && ch!= '-' && ch != '\b'){
                        e.consume();
                        
                JOptionPane.showMessageDialog(null, "Only alphabets and spaces are allowed in the Name.");
                    }
            }
        });
        ...
        t2.setFont(new Font("Raleway", Font.BOLD, 14));
            ...
            public void keyTyped(KeyEvent e){
                ...
                JOptionPane.showMessageDialog(null, "Only alphabets and spaces are allowed in the Father's Name.");
                    }
            }
        });
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if (!pincode.matches("\\d{6}")) {
                JOptionPane.showMessageDialog(null, "Invalid Pincode: must be a 6-digit number");
                return;
            }
