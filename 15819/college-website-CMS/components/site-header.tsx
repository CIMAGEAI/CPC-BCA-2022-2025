...
export default function SiteHeader({ session }: { session: Session | null }) {
  ...
  function getInitials(name: string | null | undefined): React.ReactNode {
  ...
  return (
   ...
   <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 ">
      <div className="max-w-8xl mx-auto flex mr-4 h-14 items-center justify-between">
        <div className="flex items-center space-x-5 mx-2 ml-2 ">
          <Logo />
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                           contact to our team at any time 
                          </p>
                        </div>
