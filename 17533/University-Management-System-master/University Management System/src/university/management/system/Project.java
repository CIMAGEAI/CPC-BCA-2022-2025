...
public class Project extends JFrame implements ActionListener {
    ...
    String role; // 🔴 Added to store logged-in role

    JMenuItem facultyInfo, facultydetails, updatefacultyinfo;
    ...
    public Project(String role) {
        ...
        // 🔴 Hide faculty items if user is not admin
        if (!role.equals("admin")) {
            facultyInfo.setVisible(false);
            facultydetails.setVisible(false);
            updatefacultyinfo.setVisible(false);
        }
