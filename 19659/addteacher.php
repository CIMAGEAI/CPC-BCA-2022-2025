...
<body>
				...
				<div class="container">
  <h2 class=text-center style = "color : blue">Register Teacher</h2>
...
$query="insert into teacher_info(First_name,Last_name,Position,Birth_day,Mobile_no,Sex,Permanent,Present) values('$First_name','$Last_name','$Position','$Birth_day','$Mobile_no','$Sex','$Permanent','$Present')";
$n = my_iud($query);
if($n==1)
{
