...
<h2 class = text-center style = "font-family : 'Monotype Corsiva' ; color : #E6120E">Edit Staff</h2>
<?php 
$query = "select * from employee_info where Employee_id='$id'";
$rs = my_select($query);
...
echo "<tr><th>Employee ID</th> <td><input type = text  value = $column[0] readonly></td></tr>";
...
$query = "update employee_info set First_name='$First_name',Last_name='$Last_name',Position='$Position',Birth_day='$Birth_day',Mobile_no='$Mobile_no',Sex='$Sex',Permanent='$Permanent',Present='$Present' where Employee_id='$id'";
my_iud($query);
