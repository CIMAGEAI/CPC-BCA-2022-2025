...
<div>
				...
				<div class="container">
				    <div class=row>
				        <div class="col-sm-12">
  <h1 class = text-center style = "font-family : 'Monotype Corsiva' ; color : purple"><b>View Staff</b></h1>
...
echo "<td>$column[7]</td>";
echo "<td>$column[8]</td>";																				
echo '<td><a class = "btn btn-xs btn-danger" href="deletestaff.php?id='.$column['Employee_id'].'">
													Remove
													</a></td>';
																								
echo '<td><a class="btn btn-xs btn-success" href="editstaff.php?id='.$column['Employee_id'].'">
													Edit
													</a></td>';
