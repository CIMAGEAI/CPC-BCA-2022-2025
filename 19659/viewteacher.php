...
<div>
				...
				<div class="container">
				    <div class=row>
				        <div class="col-sm-12">
  <h1 class = text-center style = "font-family : 'Monotype Corsiva' ; color : purple"><b>All Teachers</b></h1>
...
echo "<td>$column[7]</td>";
echo "<td>$column[8]</td>";																				
echo '<td><a class = "btn btn-xs btn-danger" href="deleteteacher.php?id='.$column['Teachers_id'].'">
													Remove
													</a></td>';
																								
echo '<td><a class="btn btn-xs btn-success" href="editteacher.php?id='.$column['Teachers_id'].'">
													Edit
													</a></td>';
