...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent(){
       ...
       JLabel dobD=new JLabel();
        ...
        textEmail.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ...
                if (!email.matches("^(?![.-])(?!.*[.-]{2})[a-zA-Z0-9.%+-]+(?<![.-])@([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,}$")) {
       ...
       JLabel textm12=new JLabel();
        ...
        String[] courseOptions = {"B.Tech","M.Tech","BCA","BBA","B.Sc(IT)","BBM","MBA","PGDM","MCA","B.Com","BMS"};
      ...
      /*  textBranch=new JTextField();
        ...
        try {
            ...
            while (resultSet.next())
            {
                ...
                textAadhar.setText(resultSet.getString("adhar"));
                ...
                departmentBox.setSelectedItem(resultSet.getString("Branch"));
