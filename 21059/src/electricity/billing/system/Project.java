...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        JMenuItem delCustomer = new JMenuItem("Delete Details");
        delCustomer.setFont(new Font("monospaced", Font.PLAIN, 12));
        delCustomer.setBackground(Color.WHITE);
        ImageIcon icon13 = new ImageIcon(ClassLoader.getSystemResource("icon/delete.png"));
        Image image13 = icon13.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        delCustomer.setIcon(new ImageIcon(image13));
        delCustomer.setMnemonic('Y');
        delCustomer.addActionListener(this);
        delCustomer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Y, ActionEvent.CTRL_MASK));
        master.add(delCustomer);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(msg.equals("New Customer")) {
            ...
            new CalculateBill();
        } else if (msg.equals("Delete Details")) {
            new DeleteCustomer();
